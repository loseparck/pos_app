import 'create_option_item_dto.dart';
...
class CreateProductOptionDto {
  ...
  final bool? isActive;
  final List<CreateOptionItemDto> items;
  ...
  factory CreateProductOptionDto.fromJson(Map<String, dynamic> json) {
    return CreateProductOptionDto(
      ...
      items: (json['items'] as List<dynamic>? ?? [])
          .map((e) => CreateOptionItemDto.fromJson(e as Map<String, dynamic>))
          .toList(),
